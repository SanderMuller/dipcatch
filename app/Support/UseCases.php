        ...
        return [
            'groceries' => [
                ...
                'faq' => [
                    ...
                    ['q' => __('Will it tell me about a bonus I would have seen anyway?'), 'a' => __('Only if it beats the price you picked. DipCatch is not a folder. It stays quiet until a price goes below your own line, which is what keeps the mail worth opening.')],
            ...
            'pet-food' => [
                ...
                'example' => __('A 10 kg sack of dry cat food is €44.99 at zooplus.nl and €39.95 at bol.com. Per kilo that is €4.50 against €4.00, so the same food costs 11 percent less at the second shop. Pick €40 as your price and you hear about it the next time either one moves.'),
                'tips' => [
            ...
            'filters' => [
                ...
                'tips' => [
                    ...
                    __('Name an amount in euros rather than a percentage. You buy these so rarely that a percentage has nothing to measure against.'),
                ],
                'faq' => [
                    ...
                    ['q' => __('What if I only reorder once a year?'), 'a' => __('Then pick your price and forget about it. DipCatch keeps checking and mails you when the price gets there, however long that takes.')],
            ...
            'ask-your-assistant' => [
                ...
                'example' => __('You type one message. Something like: follow this cat food, I buy it at zooplus.nl and bol.com, find two more shops, and tell me when it drops 10 percent. The assistant looks up the pages. DipCatch reads each one back with the name, the price and the pack size. Nothing is saved until you say yes.'),
                'tips' => [
                ...
                'faq' => [
                    ['q' => __('Which assistants can I use?'), 'a' => __('Claude and ChatGPT today, and other assistants that can connect to outside tools. Go to the Connections page in your account. It opens Claude with DipCatch already filled in, and it tells you what each assistant needs.')],
                    ...
                    ['q' => __('What can I ask it to do?'), 'a' => __('It can list your products and look one up. It can start following a new one, add a shop to it, or remove a shop. It can change the price you want, ask for a fresh check, show how a price moved, or stop following something. That is everything, and all of it stays inside your own account.')],
                    ['q' => __('Can it change things without asking me?'), 'a' => __('It can change the price you want, remove a shop and delete a product. So connect an assistant you trust, and cut the link on the same page when you are done. Adding always takes two steps. On the first step nothing is saved, and DipCatch tells you what it read from the page.')],
            ...
            'beauty' => [
                ...
                'description' => __('CeraVe, La Roche-Posay, Cetaphil, The Ordinary and the rest of the cabinet. Watched at Etos, Lookfantastic, Cult Beauty, Ulta, Walmart, bol.com, Amazon, Albert Heijn and Jumbo. DipCatch compares them per 100 ml or 100 g and tells you when a tub drops.'),
                ...
                'example' => __('A 454 g tub of CeraVe moisturising cream is €23.15 at etos.nl. Per 100 g that is €5.10. The 340 g tub at €18.85 is €5.54 per 100 g, so the larger tub wins until the small one goes on offer. Pick your price and you hear about it the next time either one moves.'),
                'tips' => [
                    ...
                    __('Pick your price per 100 ml or 100 g when the packs differ per shop.'),
                ...
                'faq' => [
                    ...
                    ['q' => __('What if the same cream is cheaper as a pump bottle?'), 'a' => __('Follow both and let the price per 100 g decide. A 454 g tub and a 454 g pump are the same cream at a different price each, and DipCatch shows both.')],
                ],
            ],
        ];
    }
