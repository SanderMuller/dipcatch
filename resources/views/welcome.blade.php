@php
    ...
    $faq = [
        ...
        ['q' => __('Can I use DipCatch in ChatGPT or Claude?'), 'a' => __('Yes. Ask your assistant to track a new product, add another shop to something you already follow, change when it should alert you, or say what a price has done lately. Before it saves anything it shows you the title and price it read from the page, so a wrong link is easy to catch. Setting it up takes one visit to the Connections page in your account, which says what each assistant needs.')],
