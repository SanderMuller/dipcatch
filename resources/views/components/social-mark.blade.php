...
{{--
    Brand marks, inline because neither Heroicons nor Lucide carries a
    trademarked logo. Both are drawn at Google's and Apple's published
    proportions; Google keeps its four colours, Apple is monochrome and
    follows the text colour so it reads in both themes.
--}}
@switch($provider)
    @case(\App\Enums\SocialProvider::Google)
        <svg class="shrink-0 size-4" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
    ...
    @case(\App\Enums\SocialProvider::Apple)
        <svg class="shrink-0 size-4" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false">
