...
return [
    ...
    */
    ...
    'webhook' => [
        ...
        // Cashier's defaults plus the four this app acts on itself:
        // App\Listeners\HandleStripeWebhook mirrors money and chargebacks
        // and raises the alerts. An endpoint created without them leaves
        // dunning, refunds and the chargeback queue silently dead.
        'events' => [
